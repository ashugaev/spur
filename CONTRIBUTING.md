...
First start of either sidecar in a fresh worktree is slow. It replaces the worktree's symlinked `node_modules` trees with a real `pnpm install --frozen-lockfile`.
