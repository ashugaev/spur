...
ALWAYS-ON RULES
  ...
  The `spur` SKILL.md copies link `docs/` files by raw GitHub URL, not relative path. Renaming or moving a file under `docs/` updates those raw URLs in both `spur` SKILL.md copies in the same change.
