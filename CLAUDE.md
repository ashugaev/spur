...
ALWAYS-ON RULES
  ...
  Every doc edit, down to a single config-field sentence, stays caveman compact per `docs` skill WRITE CAVEMAN: state the behavior, cut narration of internals a reader derives from the code.
