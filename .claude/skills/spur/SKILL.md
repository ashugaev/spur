...
INTERFACES
  ...
  Spur ToDo: daemon-authoritative under session-pinned policy. Resolve open and held items before completion or use the audited human override. Command, dashboard error, event, and override contract: `docs/commands.md#todo`; config policy: `docs/configuration.md`.
