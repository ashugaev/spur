#!/usr/bin/env bash
# Post product questions to Slack via Bot Token
...
BODY="*What I understood:*\n${SUMMARY}\n\n*Open questions:*\n${QUESTIONS}\n\nReply in this thread prefixed with \"Slack answers:\" — the agent will receive your answers automatically."
...
echo "Slack message sent for ${AO_ISSUE_ID} (thread_ts: ${TS}, channel: ${CHANNEL_REAL})"
