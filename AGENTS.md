...
ALWAYS-ON RULES
  ...
  Skill and agent bodies follow the FORMAT law in `skill-writer` (.agents/skills/skill-writer/SKILL.md): markdown file, minimal markdown, UPPERCASE labels and two-space indent instead of headings, tables, fences, and bullets.
