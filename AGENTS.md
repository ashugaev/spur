...
| [`spec-critic`](.agents/agents/spec-critic.md)                   | Falsify the architect's spec before the developer builds — verify facts, change map, and bound acceptance criteria |
