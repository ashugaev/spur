...
- Config spawn triggers require `spawn.prompt`, may add optional `spawn.steps`, preserve legacy scalar `spawn.agent`, and support ordered non-work-item `spawn.agents` fan-out with duplicate targets.
