...
describe("SessionService", () => {
  ...
  it("re-discovers codex session ids from the session-scoped codex home during send recovery", async () => {
    readSessionMock.mockReturnValue({
      ...
      worktreePath: "/tmp/spur-worktrees/api/api-1",
      tmuxSession: "api-1",
      launchCommand: `CODEX_HOME=${join(TEST_DATA_DIR, "session-tools", "api-1", "codex-home")} codex --enable codex_hooks --dangerously-bypass-approvals-and-sandbox`,
      status: "stopped",
      stopReason: "manual_pause",
      createdAt: "2026-03-18T10:00:00.000Z",
      updatedAt: "2026-03-18T10:01:00.000Z",
    ...
    buildAgentResumePlanMock.mockReturnValue({
      launchCommand: `CODEX_HOME=${join(TEST_DATA_DIR, "session-tools", "api-1", "codex-home")} codex resume --enable codex_hooks --dangerously-bypass-approvals-and-sandbox thread-123`,
      readyMarkers: ["›"],
    });
