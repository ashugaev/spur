...
- Clicking preview opens a full-screen artifact lightbox with close, previous, next, and download actions
- Lightbox ArrowLeft/ArrowRight moves across all session artifacts in order without wrapping; Escape closes
