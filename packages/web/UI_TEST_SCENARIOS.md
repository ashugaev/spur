...
- Sessions with tracker or jira link: Jira icon + ticket ID (e.g., WEBDEV-4617) with a compact status marker when canonical status is present
...
- Tracker/jira header badges show a compact status marker when canonical status is present
